content = """
Название рецепта: Теплый ПП салат 🥗

Рецепт:  
1. Нарезаем цветную капусту, обмазываем ее паприкой, солью и маслом, а затем отправляем в духовку на 30 минут при 200 градусах.  
2. Обжариваем курицу на сливочном масле, предварительно посолив и поперчив.  
3. Пока готовится капуста и куриные бедра, нарезаем помидоры, огурцы и укроп.  
4. Как только все приготовилось, соединяем: помидоры, огурцы, укроп, курицу, цветную капусту, фасоль и дробленые грецкие орехи.  
5. Соединяем все для заправки в отдельной миске и заправляем салат.  
